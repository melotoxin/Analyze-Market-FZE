...
export const WhyUaeSection: React.FC<WhyUaeSectionProps> = ({
  ...
  return (
    <section id="why-uae" className="py-24 sm:py-32 bg-[#050811] border-t border-white/[0.08] relative overflow-hidden transition-colors duration-300 font-sans">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-14 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight font-sans">
            {isAr ? 'لماذا تختار تأسيس شركتك في الإمارات؟' : (
              <>
                <span className="font-light text-slate-300">Why world-class leaders </span>
                <span className="font-bold text-white">choose the UAE</span>
              </>
            )}
          </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          {stats.map((st, idx) => (
            <div
              key={idx}
              className="bg-[#0b1329] border border-white/[0.08] hover:border-sky-400/60 rounded-3xl p-6 flex flex-col justify-between transition-all group motion-card shadow-lg"
            >
              <div className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-cyan-300 font-mono mb-2">
                {st.value}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="bg-[#0b1329] border border-white/[0.08] hover:border-sky-500/50 rounded-3xl p-7 space-y-3 transition-all shadow-lg">
            <div className="p-3 rounded-2xl bg-sky-500/15 text-sky-400 w-fit">
              <Globe2 className="w-6 h-6" />
            </div>
            <h3 className="text-lg font-bold text-white font-sans">Global Trade Gateway</h3>
          ...
          <div className="bg-[#0b1329] border border-white/[0.08] hover:border-sky-500/50 rounded-3xl p-7 space-y-3 transition-all shadow-lg">
            ...
            <h3 className="text-lg font-bold text-white font-sans">Safety & Legal Security</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="bg-[#0b1329] border border-white/[0.08] hover:border-sky-500/50 rounded-3xl p-7 space-y-3 transition-all shadow-lg">
            ...
            <h3 className="text-lg font-bold text-white font-sans">Capital Mobility & Freedom</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
