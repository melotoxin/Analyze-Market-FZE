...
export const FreeZonesDirectory: React.FC<FreeZonesDirectoryProps> = ({
  ...
  return (
    <section id="freezones" className="py-24 sm:py-32 bg-[#060913] border-t border-white/[0.08] relative overflow-hidden transition-colors duration-300 font-sans">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Search & Filter Bar */}
        <div className="bg-[#0b1329] border border-[#1e293b] rounded-3xl p-4 sm:p-5 mb-8 flex flex-col md:flex-row items-center justify-between gap-4 shadow-xl">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-[#080e20] border border-[#1e293b] rounded-2xl py-2.5 pl-10 pr-4 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-sky-400"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {filtered.map(fz => (
            <div
              key={fz.name}
              className={'bg-[#0b1329] border rounded-3xl p-5 flex flex-col justify-between transition-all group motion-card shadow-lg relative ' + (
                fz.featured ? 'border-sky-400/60 shadow-sky-500/10' : 'border-white/[0.08] hover:border-sky-500/50'
              )}
            >
              ...
              <div className="pt-4 mt-4 border-t border-white/[0.08] flex items-center justify-between">
                <div>
                  ...
                  <span className="text-sm font-mono font-bold text-white">{fz.minCost}</span>
                </div>
        ...
        {/* Bottom Free Zone Selection Advisory Banner (Non-repetitive) */}
        <div className="mt-8 p-6 bg-gradient-to-r from-[#0c1630] via-[#0b1329] to-[#080e20] border border-sky-500/30 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl">
